...
import fashionLoader from '../../assets/lottie/elecrtonic.json';
...
export default function Electronic() {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get('https://lavender-eel-222276.hostingersite.com/api/items/category/3')
      .then(response => {
        const fetchedProducts = response.data.data;
        if (Array.isArray(fetchedProducts)) {
          setProducts(fetchedProducts);
  ...
  return (
    <div className="min-h-screen bg-gray-900 py-10 px-4 relative">
      ...
      <h1 className="text-4xl text-white font-bold text-center mb-10">Electronic</h1>
